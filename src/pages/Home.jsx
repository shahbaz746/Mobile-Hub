...
const Home = ({ searchQuery }) => {
  ...
  const categories = ["Smartphone", "Laptop", "Tablet", "Accessories", "Wearables", "Gaming Phones", "Refurbished", "Budget Phones"];
...
console.log("Filtered:", filteredProducts);
    ...
    <>
      ...
      {categories.map((cat) => (
        <button
          ...
          className="px-5 py-2 rounded-xl text-sm font-semibold border-2 border-slate-200
  ...
  {/* Section -4: Search Results (if search query exists) */}
